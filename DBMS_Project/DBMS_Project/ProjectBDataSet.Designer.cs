...
namespace DBMS_mini.ProjectBDataSetTableAdapters {
...
SELECT Id, Title, DateCreated, TotalMarks, TotalWeightage FROM Assessment WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DBMS_mini.Properties.Settings.Default.ProjectBConnectionString;
        }
...
SELECT Id, RubricId, Details, MeasurementLevel FROM RubricLevel WHERE (Id = @Id)";
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ([Status] = @Origina" +
                "l_Status))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
...
SELECT Id, FirstName, LastName, Contact, Email, RegistrationNumber, Status FROM Student WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [FirstName] = @FirstName, [LastName] = @LastName, [Contact] = @Contact, [Email] = @Email, [RegistrationNumber] = @RegistrationNumber, [Status] = @Status WHERE (([Id] = @Original_Id) AND ([Status] = @Original_Status));
SELECT Id, FirstName, LastName, Contact, Email, RegistrationNumber, Status FROM Student WHERE (Id = @Id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, int Original_Status) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Contact, string Email, string RegistrationNumber, int Status, int Original_Id, int Original_Status, int Id) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Contact, string Email, string RegistrationNumber, int Status, int Original_Id, int Original_Status) {
            return this.Update(FirstName, LastName, Contact, Email, RegistrationNumber, Status, Original_Id, Original_Status, Original_Id);
        }
    }
